...
mod tests {
    ...
    fn deserialize() {
        let data: Vec<EOByte> = vec![
            242, 4, 255, 116, 101, 115, 116, 255, 112, 97, 115, 115, 119, 111, 114, 100, 255, 116,
            101, 115, 116, 255, 116, 101, 115, 255, 116, 101, 115, 116, 64, 101, 109, 97, 105, 108,
            46, 99, 111, 109, 255, 88, 80, 45, 86, 77, 255, 49, 56, 49, 54, 56, 52, 57, 56, 57, 54,
            255,
        ];
    ...
    fn serialize() {
        ...
        assert_eq!(
            ...
            [
                ...
                116, 101, 115, 116, 255, 116, 101, 115, 255, 116, 101, 115, 116, 64, 101, 109, 97,
                105, 108, 46, 99, 111, 109, 255, 88, 80, 45, 86, 77, 255, 49, 56, 49, 54, 56, 52,
                57, 56, 57, 54, 255
            ]
        )
    }
